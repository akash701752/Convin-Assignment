...
const LandingPage = () => {
  ...
  const intitalizeData = async () => {
    let entertainment = axios.get(
      `https://convin-backend-wxar.onrender.com/entertainment`
    );
    let education = axios.get(`https://convin-backend-wxar.onrender.com/education`);
    let motivation = axios.get(`https://convin-backend-wxar.onrender.com/motivation`);
  ...
  const onUpdate = async (id: string, type: string) => {
    ...
    await axios.put(
      `https://convin-backend-wxar.onrender.com/${currentlyOpenCard?.category}/${id}`,
      {
  ...
  const onDelete = async (id: string, type: string) => {
    await axios.delete(`https://convin-backend-wxar.onrender.com/${type}/${id}`, {
      headers: {
        "Content-Type": "application/json",
      },
    });
  ...
  const updateTimesPlayed = async () => {
    await axios.put(
      `https://convin-backend-wxar.onrender.com/${currentlyOpenCard?.category}/${currentlyOpenCard?.id}`,
      {
        ...currentlyOpenCard,
                  ...
                  >
                    ...
                    <Grid item>
                      <Button
                        onClick={async () => {
                          await axios.post(
                            `https://convin-backend-wxar.onrender.com/${cardCreationPayload?.category}`,
                            {
                              id: new Date().valueOf(),
                              ...cardCreationPayload,
                            },
                ...
                >
                  ...
                  >
                    ...
                    <Button
                      ...
                      onClick={async () => {
                        await axios.post(
                          `https://convin-backend-wxar.onrender.com/${shiftedCategory}`,
                          {
                            ...currentlyOpenCard,
                            id: new Date().valueOf(),
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      for (
                        ...
                        await axios.delete(
                          `https://convin-backend-wxar.onrender.com/education/${educationChecklist?.[itr]?.id}`,
                          {
                            headers: {
                              "Content-Type": "application/json",
                            },
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      for (
                        ...
                        await axios.delete(
                          `https://convin-backend-wxar.onrender.com/motivation/${motivationChecklist?.[itr]?.id}`,
                          {
                            headers: {
                              "Content-Type": "application/json",
                            },
